...
if __name__ == '__main__':
    ...
    agent = Agent(activation_func='tanh', genotype=None)
    AgentNN.train_follow_phero(agent, epochs=100000, random_states=1000, lr=0.001, loss_graph=True, save_loss_data=True)
    # input()
